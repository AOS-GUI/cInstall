...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap("files/apps/assets/mediaplayer/images/control-skip-180.png"), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addPixmap(QPixmap("files/apps/assets/mediaplayer/images/control.png"), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addPixmap(QPixmap("files/apps/assets/mediaplayer/images/control-pause.png"), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addPixmap(QPixmap("files/apps/assets/mediaplayer/images/control-stop-square.png"), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addPixmap(QPixmap("files/apps/assets/mediaplayer/images/control-skip.png"), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addPixmap(QPixmap("files/apps/assets/mediaplayer/images/application-image.png"), QIcon.Normal, QIcon.Off)
        ...
        self.label.setText("")
        self.label.setPixmap(QPixmap("files/apps/assets/mediaplayer/images/speaker-volume.png"))
